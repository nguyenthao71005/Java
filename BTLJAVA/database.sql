...
-- =============================================================================
-- 10. BẢNG NHẬT KÝ TRUY CẬP (LichSuTruyCap) & THAO TÁC (LichSuThaoTac) - AUDIT LOG
-- Phục vụ: Quản trị viên theo dõi an ninh hệ thống, lịch sử đăng nhập/đăng xuất và thao tác dữ liệu
-- =============================================================================
CREATE TABLE IF NOT EXISTS `LichSuTruyCap` (
    ...
    `TrinhDuyet` VARCHAR(255) NULL COMMENT 'User-Agent / Tên máy / Thiết bị',
...
CREATE TABLE IF NOT EXISTS `LichSuThaoTac` (
    ...
    `HoTen` VARCHAR(100) NULL COMMENT 'Họ tên nhân viên',
    `TenBang` VARCHAR(50) NOT NULL COMMENT 'Tên bảng bị tác động (NhanVien, MonAn, HoaDon...)',
