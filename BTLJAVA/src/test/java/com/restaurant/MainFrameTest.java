...
public class MainFrameTest {
    ...
    public void testMainFrameInitializationAndCardSwitching() throws InterruptedException, InvocationTargetException {
        SwingUtilities.invokeAndWait(() -> {
            ...
            frame.showCard(MainFrame.CARD_AUDIT_LOG);
            assertNotNull(frame.getAuditLogPanel());
    ...
    @Test
    public void testRoleBasedAccessControl() throws InterruptedException, InvocationTargetException {
        SwingUtilities.invokeAndWait(() -> {
            // 1. Admin login
            com.restaurant.model.NhanVien admin = new com.restaurant.model.NhanVien(1, "Quản trị viên", "admin", "admin123", "Admin", "DangLam");
            MainFrame adminFrame = new MainFrame(admin);
            assertNotNull(adminFrame.getAuditLogPanel());
            adminFrame.dispose();

            // 2. Quản lý login
            com.restaurant.model.NhanVien quanly = new com.restaurant.model.NhanVien(2, "Quản lý Nhà hàng", "quanly", "quanly123", "QuanLy", "DangLam");
            MainFrame quanLyFrame = new MainFrame(quanly);
            assertNotNull(quanLyFrame.getDashboardPanel());
            quanLyFrame.dispose();
        });
    }
