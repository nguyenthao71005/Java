...
public class DummyDataFactory {
    ...
    private void initEmployees() {
        ...
        danhSachNhanVien.add(new NhanVien(1, "Quản trị viên Hệ thống", "admin", "admin123", "Admin", "DangLam"));
        danhSachNhanVien.add(new NhanVien(2, "Trần Văn Quản Lý", "quanly", "quanly123", "QuanLy", "DangLam"));
        danhSachNhanVien.add(new NhanVien(3, "Trần Thị Mai", "cashier01", "mai123", "ThuNgan", "DangLam"));
        danhSachNhanVien.add(new NhanVien(4, "Lê Hoàng Nam", "waiter01", "nam123", "PhucVu", "DangLam"));
        danhSachNhanVien.add(new NhanVien(5, "Phạm Quốc Tuấn", "chef01", "tuan123", "Bep", "DangLam"));
        danhSachNhanVien.add(new NhanVien(6, "Đỗ Kim Ngân", "cashier02", "ngan123", "ThuNgan", "DangLam"));
        danhSachNhanVien.add(new NhanVien(7, "Vũ Đức Thịnh", "waiter02", "thinh123", "PhucVu", "NghiViec"));
        danhSachNhanVien.add(new NhanVien(8, "Nguyễn Phương Thảo (Admin)", "admin02", "admin123", "Admin", "DangLam"));
    }
