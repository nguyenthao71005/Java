...
public class LoginDialog extends JDialog {
    ...
    private void initUI() {
        ...
        JLabel lblHint = new JLabel("<html><center style='color:#64748B; font-size:11px;'>" +
                ...
                "<b>admin</b> / <b>admin123</b> (Admin - Quản trị hệ thống & AuditLog)<br>" +
                "<b>quanly</b> / <b>quanly123</b> (Quản lý - Toàn quyền hệ thống)<br>" +
                "<b>cashier01</b> / <b>mai123</b> (Thu ngân) | <b>waiter01</b> / <b>nam123</b> (Phục vụ)" +
    ...
    private void handleLogin() {
        ...
        if (user != null) {
            // Ghi nhận đăng nhập thành công vào Audit Log
            auditService.ghiDangNhap(user);
            this.authenticatedUser = user;
            dispose();
        } else {
            // Ghi nhận đăng nhập thất bại
            auditService.ghiDangNhapThatBai(username, "Sai mật khẩu");
